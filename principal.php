...
$result1 = $BD->ejecutar($sql1);
$result = $BD->ejecutar($sql);

*/

$ListaSolicitudes = new ConsultasDAO();
$lista = $ListaSolicitudes->ListarSolicitudes();
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Listado de Solicitudes</h4>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width='40%'>Cabecera Solicitud</th>
                                                <th width='40%'>Detalle Solicitud</th>
                                                       ...
                                                       // echo $row['idesolicitud'];
                                                        ...
                                                        echo "
                                                            ...
                                                            <tr>
                                                                ...
                                                                {echo "<input type=button value='Rechazar Solicitud' onclick=cancelar('controlador.php?pagina=8&idesolicitud=".$row['idesolicitud']."&idusuario=".$_SESSION['idusuario']."');>";}
                                                                "												
                                                                </td>
